...
<head>
    ...
    <link rel="stylesheet" href="{{url('admin/assets/vendor/animate-css/animate.min.css')}}">
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="{{url('admin/assets/images/thumbnail.png')}}" width="48" height="48" alt="Mplify"></div>
        <p>Please wait...</p>
    </div>
</div>
    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="index.html">
                    <img src="{{url('admin/assets/images/logo-icon.svg')}}" alt="Mplify Logo" class="img-responsive logo">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle icon-menu" data-toggle="dropdown">
                                        <img class="rounded-circle" src="{{url('admin/assets/images/user-small.png')}}" width="30" alt="">
                                    </a>
                                    <div class="dropdown-menu animated flipInY user-profile">
                                        <div class="d-flex p-3 align-items-center">
                                            <div class="drop-left m-r-10">
                                                <img src="{{url('admin/assets/images/user-small.png')}}" class="rounded" width="50" alt="">
                                            </div>
        ...
        <div class="sidebar-scroll">
            <nav id="leftsidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="app-inbox.html"><i class="icon-envelope"></i><span>Category</span></a></li>
                    <li><a href="app-chat.html"><i class="icon-bubbles"></i><span>State</span></a></li>
                    <li><a href="app-calendar.html"><i class="icon-calendar"></i><span>District</span></a></li>
                    <li><a href="app-taskboard.html"><i class="icon-notebook"></i><span>Location</span></a></li>
                            ...
                            <div class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="{{url('admin/assets/images/image-gallery/1.jpg')}}" class="img-fluid" alt="img" />
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{url('admin/assets/images/image-gallery/2.jpg')}}" class="img-fluid" alt="img" />
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{url('admin/assets/images/image-gallery/3.jpg')}}" class="img-fluid" alt="img" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="right_chat list-unstyled">
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{url('admin/assets/images/xs/avatar4.jpg')}}" alt="">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{url('admin/assets/images/xs/avatar5.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{url('admin/assets/images/xs/avatar2.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{url('admin/assets/images/xs/avatar1.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{url('admin/assets/images/xs/avatar3.jpg')}}" alt="">
                                            <div class="media-body">
                            ...
                            <ul class="list-unstyled contact-list">
                                <li class="d-flex align-items-center">
                                        <span class="contact-img">
                                            <img src="{{url('admin/assets/images/xs/avatar1.jpg')}}" class="rounded" alt="">
                                        </span>
                                    <h4 class="contact-name">Vincent Porter <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                        <span class="contact-img">
                                            <img src="{{url('admin/assets/images/xs/avatar2.jpg')}}" class="rounded" alt="">
                                        </span>
                                    <h4 class="contact-name">Mike Thomas <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                        <span class="contact-img">
                                            <img src="{{url('admin/assets/images/xs/avatar3.jpg')}}" class="rounded" alt="">
                                        </span>
                                    <h4 class="contact-name">Aiden Chavaz</h4>
                                </li>
                                <li class="d-flex align-items-center">
                                        <span class="contact-img">
                                            <img src="{{url('admin/assets/images/xs/avatar4.jpg')}}" class="rounded" alt="">
                                        </span>
                                    <h4 class="contact-name">Vincent Porter <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                        <span class="contact-img">
                                            <img src="{{url('admin/assets/images/xs/avatar5.jpg')}}" class="rounded" alt="">
                                        </span>
                                    <h4 class="contact-name">Mike Thomas <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                        <span class="contact-img">
                                            <img src="{{url('admin/assets/images/xs/avatar6.jpg')}}" class="rounded" alt="">
                                        </span>
                                    <h4 class="contact-name">Aiden Chavaz</h4>
                                </li>
                            </ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="desc">
                                            ...
                                            <ul class="list-unstyled team-info margin-0 p-t-5">
                                                <li><img src="{{url('admin/assets/images/xs/avatar1.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{url('admin/assets/images/xs/avatar2.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{url('admin/assets/images/xs/avatar3.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{url('admin/assets/images/xs/avatar4.jpg')}}" alt="Avatar"></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
...
<script src="{{url('admin/assets/bundles/morrisscripts.bundle.js')}}"></script>
</body>
</html>